...
AS
    ...
    IS
        ...
        ----------------------------------------------------------------------------------------------------------------------------              
        BEGIN
                DELETE B_Customer_Karateev_VG;                            -- Очистка таблицы № 1 "Customer"
                DELETE B_Product_Karateev_VG;                             -- Очистка таблицы № 2 "Product"
                DELETE B_orders_Karateev_VG;                              -- Очистка таблицы № 3 "Orders"
                DELETE B_fin_Karateev_VG;                                 -- Очистка таблицы № 4 "FIN"
                DELETE A_basic_shop_Karateev_VG;                          -- Очистка базовой витрины
                EXECUTE IMMEDIATE 'TRUNCATE TABLE A_final_1_showcasev_VG DROP STORAGE';-- Очистка итоговой витрины № 1
                EXECUTE IMMEDIATE 'TRUNCATE TABLE A_final_3_showcasev_VG DROP STORAGE';-- Очистка итоговой витрины № 2
                EXECUTE IMMEDIATE 'TRUNCATE TABLE A_final_3_showcasev_VG DROP STORAGE';-- Очистка итоговой витрины № 3
        --------------------------------------------------------------  
